...
test_img_RBG_input = np.array([[[ 12.,  18.,  28.],[ 24.,  36.,   7.],[ 48.,   9.,  14.]],
                      ...
                      [[ 72., 108., 168.],[144., 216.,  42.],[288.,  54.,  84.]]], dtype = "uint8")
...
skimage.io.imsave("test_py/test_image/test_img_RGB_ex_output", test_img_RGB_ex_output)
...
def test_wrong_input_type():
    with pytest.raises(AttributeError):
        RGB_manipulation(12345, "test_py/test_image/test_img_RGB_ex_output", R= 1, G=2, B=3)
...
def test_wrong_input_type():
    with pytest.raises(AttributeError):
        RGB_manipulation(12345, "test_py/test_image/test_img_RGB_ex_output", R= 1, G=2, B=3, 123)
